...
- When searching for a missing entity, have an option to generate it (do an internet search, find relevant data)
  - Similarly, update or refresh a page, or update given a particular set of data
...
## Questions
- How do we relate to longtermwiki? (should we join forces?)
  - Focus on grantmaking vs general info? Not clear this is that important
  - Different data model (files vs db)?
